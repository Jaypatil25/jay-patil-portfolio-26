        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Building modern, responsive web applications with cutting-edge technologies. Experienced in frontend frameworks, backend services, and database design for scalable solutions.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Crafting beautiful, intuitive user interfaces with focus on responsive design and user experience. Experienced in designing scalable components and brand identities.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
